...
- Direction respects the subject-of-verb: `pedro-franceschi --attended--> meetings/2026-04-03` reads naturally because the person is the subject.
...
# Sample a real entity — depth-2 should return many more nodes than before.
gbrain graph diana-hu --depth 2

# Filter to specific edge types (new in v0.13).
gbrain graph diana-hu --depth 2 --type yc_partner,invested_in
...
3. If that fails too, file an issue: https://github.com/garrytan/gbrain/issues with doctor output + upgrade-errors.jsonl contents. This is how Garry finds fragile upgrade paths.
